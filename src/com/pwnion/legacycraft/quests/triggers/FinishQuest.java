...
public class FinishQuest {
	...
	public static void onFinishQuest(Player p, Quest quest) {
		...
		if (quest.getNextQuest() != null) {
			 ...
			 * else { //Give the player the next quest in the quest line
			 * QuestManager.getQuestLineQuest(quest.questLine, quest.questLineIndex +
			 * 1).addPlayer(p); } //
			 */
	}

	/*
	 * //Called from above public static void onFinishQuestLine(Player p, String
	 * questLine) { p.sendMessage(ChatColor.GOLD + "You have competed the '" +
